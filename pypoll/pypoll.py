...
file_num = 2
file = os.path.join('pypoll', 'pypoll_data' + str(file_num) + '.csv')
...
with open(file, 'r') as csvfile:
    ...
    # make dictionary from file using column 3 as keys
...
# Uses dictionary keys and values & puts them into lists, 
...
# determine winner_list to put winners (even if there is a tie)
winner_list = []
